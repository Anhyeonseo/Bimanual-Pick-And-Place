...
<!--
  성공 실행 영상/사진을 여기 삽입.
  영상: [![demo](docs/media/demo-thumbnail.png)](docs/media/demo.mp4)
  사진: ![pick and place](docs/media/pick-and-place.jpg)
-->
...
규범 경계는
[양팔 상단 애플리케이션 인터페이스](docs/BIMANUAL_UPPER_APPLICATION_INTERFACE.md)에,
전체 이력과 최종 수락 결과는
[현재 상태](docs/CURRENT_STATE_AND_NEXT_ROADMAP.md)에 기록했다.
